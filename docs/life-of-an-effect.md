...
The `resourceType` field makes Recyclon inherit from `ResourceCard<Class<Microbe>>`. It also
contributes the declaration that makes `Microbe` an appropriate Card Resource. The Definition adds

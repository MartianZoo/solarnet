...
- **Signal:** An unscoped point event. A direct gain is recorded as one self-transmutation and never enters live state. A Signal gained from another Component is immediately removed by its declared effect.

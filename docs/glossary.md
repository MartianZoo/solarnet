...
- **System:** Admin-only machinery. It extends `Hidden`, cannot be created by a Player, and an unowned System occurrence does not implicitly restrict Effect matching by its Actor.

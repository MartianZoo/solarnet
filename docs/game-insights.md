...
* Greenery-to-oxygen is intrinsic to `GreeneryTile`, including during final greenery. Solo setup locally cancels the oxygen from each neutral greenery instead of making the general greenery rule depend on the phase.

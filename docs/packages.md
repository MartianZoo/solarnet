...
provides an independent, editable setup-world vocabulary and converts its resolved options into
affirmative gameplay modules in reusable `GamePremise` values.

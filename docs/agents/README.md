...
| Derived Classes, default insertion into instructions, or Type-variable lifetime in the engine | The matching section of [`TYPES.md`](TYPES.md) | Current model and working direction |

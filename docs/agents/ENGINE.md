...
`TfmWorkflow.Automatic` coordinates the remaining player-ordered phase work in a coroutine. It
commits before waiting for tasks to drain and wakes from the shared outermost

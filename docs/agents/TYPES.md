...
The table is built by filtering the declarations supplied by one Authority and then freezing it.
Once frozen, its classes and subtype relationships cannot

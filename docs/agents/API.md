...
Task selection remains assignee-scoped. An instruction-level `BY` changes the performer credited on
state changes, not the Agent authorized to select the task.

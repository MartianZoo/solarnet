...
Do not retain obsolete aliases merely to preserve the current public API. Script and replay syntax
are separately visible contracts and must be migrated deliberately.

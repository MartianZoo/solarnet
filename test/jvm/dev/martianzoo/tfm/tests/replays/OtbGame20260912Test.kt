...
internal class OtbGame20260912Test : AbstractFullGameTest() {
  ...
  internal fun completeGame() {
    ...
    // "Ellie does World Government ... ocean ... five seven." The placement grants no TR; the
    // settled operation includes Yellow's ensuing uninfluenced Turmoil revision.
    yellow.wgt("OceanTile<Vastitas_5_7>").expect("-TerraformRating<Yellow>")
    ...
    yellow.exMachina("6 MC")
    // The placement grants no TR; the settled operation includes the ensuing Turmoil revision.
    yellow.wgt("OceanTile<Vastitas_4_3>").expect("-TerraformRating<Yellow>")
    ...
    // The step grants no TR; the settled operation includes the ensuing Turmoil revision.
    blue.wgt("VenusStep").expect("-TerraformRating<Blue>")

...
/** Section 10 of `docs/pets-language-spec.md`: the names a source may write. */
internal class Lang10NamesTest {

  // L10-1 The shape of a class name

  @Test
  internal fun `L10-1 an uppercase-leading identifier is a class name`() {
  ...
  @Test
  internal fun `L10-1 other shapes are not class names`() {
  ...
  @Test
  internal fun `L10-2 a keyword is not a class name`() {
  ...
  @Test
  internal fun `L10-2 every reserved word is one the grammar itself takes`() {
  ...
  @Test
  internal fun `L10-2 reserved spellings are exact, and former keywords are class names`() {
    parse<Expression>("Has<By, Max, AS>").toString() shouldBe "Has<By, Max, AS>"
    parse<Expression>("Rank").className shouldBe cn("Rank")
  }

  @Test
  internal fun `L10-2 declaration keywords do not consume identifier prefixes`() {
  ...
  // L10-3 Property names

  @Test
  internal fun `L10-3 a property name is lower camel case`() {
  ...
  // L10-4 Transform-kind names

  @Test
  internal fun `L10-4 a transform kind is an all-caps word`() {
  ...
  // L10-5 The global class-name namespace

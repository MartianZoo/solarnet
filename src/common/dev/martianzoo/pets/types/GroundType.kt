...
public data class GroundType(
  ...
  /**
   * This value itself, because a ground type is its own structural interpretation ([rule
  ...
  /**
   * Enumerates every concrete narrowing in the master universe according to
   ...
   * The sequence can be very large.
   */

...
public data class GroundType(
  ...
  /**
   * A minimal common supertype with [that], including the refinement rules ([rules T7-2 and
   * T8-10](https://github.com/MartianZoo/solarnet/blob/main/docs/type-system-spec.md#7-bounds)).
   */

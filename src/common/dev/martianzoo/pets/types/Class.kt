...
internal constructor(
   ...
   * T2-12](https://github.com/MartianZoo/solarnet/blob/main/docs/type-system-spec.md#2-classes)).
   */
   ...
   * of
   * [rule T2-9](https://github.com/MartianZoo/solarnet/blob/main/docs/type-system-spec.md#2-classes).
   *
   * @throws IllegalArgumentException if [that] belongs to another universe (rule T1-2).
   */
   ...
   * [rules T1-1 and T2-12](https://github.com/MartianZoo/solarnet/blob/main/docs/type-system-spec.md#1-universes-and-identity).
   */
   ...
   * [rule T2-12](https://github.com/MartianZoo/solarnet/blob/main/docs/type-system-spec.md#2-classes).
   */

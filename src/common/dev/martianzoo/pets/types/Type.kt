 ...
 * either a ground type or one authored occurrence of a type variable.
 *
 * Consumers interested only in structural meaning can use [groundType]. Consumers interpreting
...
public interface Type : HasExpression, HasClassName, Specification<Type> {
  /**
   * This type's structural interpretation after forgetting variable identity, as specified by

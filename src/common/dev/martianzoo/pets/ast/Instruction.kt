  ...
  public data class Transmute(
    ...
    override fun ensureIsNarrowedBy(proposed: InstructionTree, info: TypeInfo) {
      ...
      for (variable in
        ...
        val bindings =
            variables.bindings(gaining, proposed.gaining, variable, info) +
                variables.bindings(removing, proposed.removing, variable, info)
  ...
  internal constructor(
    ...
    private fun bindTypeVariablesFrom(
      ...
      for (variable in
        ...
        val bindings =
            variables
                .bindings(this, proposed, variable, info)
                .filter {
          ...
          PetTransformer.chain(
              variables.variables.mapNotNull { variable ->
                ...
                val positionalBindings =
                    variables
                        .bindings(selectableFirst, proposed, variable, info)

...
import dev.martianzoo.tfm.script.Access.RedMode
import dev.martianzoo.tfm.script.Access.YellowMode
import dev.martianzoo.tfm.script.ScriptSession.ScriptMode.BLUE
import dev.martianzoo.tfm.script.ScriptSession.ScriptMode.GREEN
import dev.martianzoo.tfm.script.ScriptSession.ScriptMode.PURPLE
import dev.martianzoo.tfm.script.ScriptSession.ScriptMode.RED
import dev.martianzoo.tfm.script.ScriptSession.ScriptMode.YELLOW
...
import dev.martianzoo.tfm.script.commands.AsCommand
import dev.martianzoo.tfm.script.commands.AutoCommand
import dev.martianzoo.tfm.script.commands.BecomeCommand
import dev.martianzoo.tfm.script.commands.CountCommand
import dev.martianzoo.tfm.script.commands.DescCommand
import dev.martianzoo.tfm.script.commands.ExecCommand
import dev.martianzoo.tfm.script.commands.HasCommand
import dev.martianzoo.tfm.script.commands.HelpCommand
import dev.martianzoo.tfm.script.commands.ListCommand
import dev.martianzoo.tfm.script.commands.LogCommand
import dev.martianzoo.tfm.script.commands.ModeCommand
import dev.martianzoo.tfm.script.commands.NewGameCommand
import dev.martianzoo.tfm.script.commands.PhaseCommand
import dev.martianzoo.tfm.script.commands.RollbackCommand
import dev.martianzoo.tfm.script.commands.StatusCommand
import dev.martianzoo.tfm.script.commands.TaskCommand
import dev.martianzoo.tfm.script.commands.TasksCommand

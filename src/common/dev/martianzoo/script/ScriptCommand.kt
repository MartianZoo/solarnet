...
public abstract class ScriptCommand(public val name: String) {
  ...
  public open fun completions(context: ScriptCompletionContext): List<ScriptCompletion> =
      emptyList()

  public open fun completionPrefix(parsedWord: String): String =
      ScriptCompletionContext.fragment(parsedWord)
}

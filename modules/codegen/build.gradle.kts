...
configurations[generatedPetsTypes.implementationConfigurationName].extendsFrom(
...
tasks.named(generatedPetsTypes.getCompileTaskName("kotlin")) {
  dependsOn(generatePetsTypes)
}

tasks.named("check") {
  dependsOn(generatedPetsTypes.classesTaskName)
}

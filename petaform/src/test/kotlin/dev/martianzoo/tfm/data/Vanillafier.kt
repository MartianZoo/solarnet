    ...
    fun <P : PetaformNode?> san(n: P): P {
        ...
        return n.apply {
            when (this) {
                ...
                is Instruction.FromIsBelow -> copy("Foo", san(specializations), san(predicate))
                is Instruction.FromIsRightHere -> copy(san(to), san(from))
                is Instruction.FromIsNowhere -> copy(san(type))

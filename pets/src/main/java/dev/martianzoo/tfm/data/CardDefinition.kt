...
import dev.martianzoo.tfm.data.TfmClassNames.ACTION_CARD
import dev.martianzoo.tfm.data.TfmClassNames.ACTIVE_CARD
import dev.martianzoo.tfm.data.TfmClassNames.AUTOMATED_CARD
import dev.martianzoo.tfm.data.TfmClassNames.CARD_FRONT
import dev.martianzoo.tfm.data.TfmClassNames.CORPORATION_CARD
import dev.martianzoo.tfm.data.TfmClassNames.END
import dev.martianzoo.tfm.data.TfmClassNames.EVENT_CARD
import dev.martianzoo.tfm.data.TfmClassNames.PRELUDE_CARD
import dev.martianzoo.tfm.data.TfmClassNames.PROJECT_CARD
import dev.martianzoo.tfm.data.TfmClassNames.RESOURCE_CARD

...
interface Definition : HasClassName {
   ...
   * instructions to refer back to this definition. For example, instead of `Tile` having an
   * effect like `@lookUpMapBonus(MarsArea)`, each `MarsArea` class should have an effect like
   * `Tile<This>: 2 Plant`.
   */

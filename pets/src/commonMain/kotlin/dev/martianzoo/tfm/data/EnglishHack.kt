...
internal object EnglishHack {
  ...
  private val ENGLISH_HACK: Map<String, ClassName> =
      classNameMap(
          ...
          "HA4" to "Contractor",
          "HA5" to "Celebrity",
          "HA6" to "Industrialist",
          "HA7" to "DesertSettler",
          "HA8" to "EstateDealer",
          "HA9" to "Benefactor",
          "VA1" to "Venuphile",
          "UA0" to "Suburbian",
          ...
          "X50" to "AqueductSystems",
          "X51" to "AstraMechanica",
          "X52" to "CarbonNanosystems",
          "X53" to "CyberiaSystems",
          "X54" to "EstablishedMethods",
          "X55" to "GiantSolarCollector",
          "X56" to "HermeticOrderOfMars",
          "X57" to "HomeostasisBureau",
          "X58" to "KaguyaTech",
          "X59" to "MarsNomads",
          "X60" to "MartianLumberCorp",
          "X61" to "NeptunianPowerConsultants",
          "X62" to "RedShips",
          "X63" to "SolarLogistics",
          "X64" to "StJosephOfCupertinoMission",
          "X65" to "StrategicBasePlanning",
          "X66" to "Teslaract",
          "X67" to "SoilEnrichment",
          "X68" to "Supermarkets",
          "X69" to "Hospitals",
          "X70" to "PublicBaths",
          "X71" to "CityParks",
          "X72" to "Casinos",
          "X73" to "ProtectedGrowth",
          "X74" to "StaticHarvesting",
          "X75" to "Vermin",
          "X76" to "WeatherBalloons",
          "X77" to "PublicPlans",
          "X78" to "AlbedoPlants",
          "X79" to "SterlingVents",
          "XM1" to "FloydContinuum",
          "XM2" to "NewHolland",
          "XC01" to "ArcadianCommunities",
          "XC02" to "Recyclon",
          "XC03" to "SpliceTacticalGenomics",
          "XC04" to "Factorum",
          "XC05" to "MonsInsurance",
          "XC06" to "Philares",
          "XC07" to "Astrodrill",
          "XC08" to "PharmacyUnion",
          "XC09" to "TychoMagnetics",
          "XC10" to "KuiperCooperative",
          "XC11" to "PolderTechDutch",

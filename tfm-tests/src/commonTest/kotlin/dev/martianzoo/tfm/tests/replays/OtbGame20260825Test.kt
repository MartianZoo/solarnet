...
/** Physical game begun Tuesday 2026-08-25 and adjourned before Generation 6 Research. */
internal class OtbGame20260825Test : AbstractFullGameTest() {
  ...
  internal fun otbGame20260825() {
    ...
    dad.playCorp(TerraLabsResearch, 10).expect("4 MC, 10 ProjectCard, -TR")
    ...
    with(dad) {
      ...
      assertCounts(21 to "TR", 1 to "Philantropist")
    ...
    with(ellie) {
      ...
      assertCounts(34 to "TR", 1 to "Farmer")

...
- [#61: Temporary cleanup](https://github.com/MartianZoo/solarnet/issues/61) — Standardize trusted-client settlement of uniquely implied cleanup beyond `TfmGameplay`'s wild-tag handling.
